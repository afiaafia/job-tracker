    ...
    <header className="border-b border-[#E5EAF2] bg-white">
      <div className="flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="flex h-10 w-10 items-center justify-center rounded-xl border border-[#E5EAF2] text-lg text-[#64748B] lg:hidden"
          ...
          <div className="lg:hidden">
            <p className="text-base font-bold text-[#17233A]">JobTrack</p>
          </div>

          <div className="hidden lg:block">
            <p className="text-sm font-semibold text-[#17233A]">Dashboard</p>
          </div>
        </div>
